...
dragElement(document.getElementById('plant1'), false);
dragElement(document.getElementById('plant2'), false);
dragElement(document.getElementById('plant3'), false);
dragElement(document.getElementById('plant4'), false);
dragElement(document.getElementById('plant5'), false);
dragElement(document.getElementById('plant6'), false);
dragElement(document.getElementById('plant7'), false);
dragElement(document.getElementById('plant8'), false);
dragElement(document.getElementById('plant9'), false);
dragElement(document.getElementById('plant10'), false);
...
function dragElement(terrariumElement, isClone) {
